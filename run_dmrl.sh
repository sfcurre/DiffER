...
python train.py --name BackwardDiffusionContinuous_PadLimit20_Fine1 --config_path configs/pad_limit_20_continuous.yaml --load out/models/BackwardDiffusionContinuous_PadLimit20_29.pkl